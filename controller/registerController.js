eLearningApp.controller(registrationController,['$scope','registerDetails','$state',registrationController]);
function registrationController($scope,registerDetails,$state){
 	$scope.phoneNumber = '';
 	$scope.term1 = 100;
 	$scope.term2 = 200;
 	$scope.term3= 300;	
